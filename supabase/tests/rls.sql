...
insert into public.supply_purchases(business_id,supply_id,package_quantity,package_unit,package_price,purchased_at) values
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa','aaaaaaaa-0000-4000-8000-000000000001',1000,'g',30,current_date-1),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb','bbbbbbbb-0000-4000-8000-000000000001',1000,'g',40,current_date-1);
