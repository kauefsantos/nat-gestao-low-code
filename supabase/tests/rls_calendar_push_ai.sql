...
select ok((select relrowsecurity from pg_class where oid='public.calendar_events'::regclass),'calendar_events has RLS enabled');
...
select ok((select relrowsecurity from pg_class where oid='public.notification_delivery_log'::regclass),'notification_delivery_log has RLS enabled');
...
select ok(not has_function_privilege('authenticated','public.get_push_backend_config()','execute'),'authenticated clients cannot execute push backend secret RPC');
...
select throws_ok(
  $$select public.save_calendar_event_v3('cccccccc-cccc-4ccc-8ccc-cccccccccccc','cccccccc-1000-4000-8000-000000000001','cccccccc-0000-4000-8000-000000000010',null,'2026-09-21','09:30','content','AAL1 blocked',null,null,null,'planned',false)$$,
...
select lives_ok(
  $$select public.save_calendar_event_v3('cccccccc-cccc-4ccc-8ccc-cccccccccccc','cccccccc-1000-4000-8000-000000000002','cccccccc-0000-4000-8000-000000000010',null,'2026-09-21','09:30','content','Post Tenant A','Teste de conteúdo','Instagram','Engajamento','planned',false)$$,
  'AAL2 member can save an event in its own tenant'
);
select throws_ok(
  $$select public.save_calendar_event_v3('dddddddd-dddd-4ddd-8ddd-dddddddddddd','cccccccc-1000-4000-8000-000000000003','dddddddd-0000-4000-8000-000000000010',null,'2026-09-21','09:30','content','Cross tenant blocked',null,null,null,'planned',false)$$,
