...
select lives_ok($sql$
  select public.apply_nat_transition_v4(
    ...
    '[{"type":"save_supply","expectedUpdatedAt":null,"payload":{"id":"f3000000-0000-4000-8000-000000000002","name":"Chocolate Marca B","category":"ingredient","packageQuantity":100,"packageUnit":"g","packagePrice":30,"purchasedAt":"2026-09-13","fundingSource":"business","equivalentToSupplyId":"f3000000-0000-4000-8000-000000000001"}}]'::jsonb
  )
...
select lives_ok($sql$
  select public.apply_nat_transition_v4(
    ...
    '[{"type":"save_supply","expectedUpdatedAt":null,"payload":{"id":"f3000000-0000-4000-8000-000000000002","name":"Chocolate Marca B","category":"ingredient","packageQuantity":50,"packageUnit":"g","packagePrice":15,"purchasedAt":"2026-09-14","fundingSource":"business","equivalentToSupplyId":null}}]'::jsonb
  )
$sql$,'a repeat purchase reuses the same supply identity');
...
select throws_ok($sql$
  select public.apply_nat_transition_v4(
    ...
    '[{"type":"save_supply","expectedUpdatedAt":null,"payload":{"id":"f3000000-0000-4000-8000-000000000003","name":"  chocolate   marca b ","category":"ingredient","packageQuantity":10,"packageUnit":"g","packagePrice":4,"purchasedAt":"2026-09-15","fundingSource":"business","equivalentToSupplyId":null}}]'::jsonb
  )
...
select lives_ok($sql$
  select public.apply_nat_transition_v4(
    ...
    '[{"type":"save_supply","expectedUpdatedAt":null,"payload":{"id":"f3000000-0000-4000-8000-000000000001","name":"Chocolate Marca A","category":"ingredient","packageQuantity":50,"packageUnit":"g","packagePrice":6,"purchasedAt":"2026-09-16","fundingSource":"business","equivalentToSupplyId":"f3000000-0000-4000-8000-000000000002"}}]'::jsonb
  )
$sql$,'an earlier brand can become current again without losing either history');
