...
import { initialState, type NatState, type PaymentMethod, type Product, type RecipeItem, type Settings, type Supply, type SupplyCategory, type Unit } from "@/domain/nat";
...
async function rpc(name: "delete_sale" | "archive_product" | "delete_supply" | "save_supply" | "save_product" | "save_sale" | "save_business_settings", params: Record<string, unknown>) {
