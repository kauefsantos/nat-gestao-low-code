/* eslint-disable */
// @ts-nocheck
// This file is generated by TanStack Router and may be overwritten.
...
export interface FileRouteTypes {
  ...
  id: '__root__' | '/' | '/_authenticated' | '/login' | '/signup' | '/_authenticated/dashboard'
...
interface AuthenticatedRouteChildren { AuthenticatedDashboardRoute: typeof AuthenticatedDashboardRoute }
const AuthenticatedRouteChildren: AuthenticatedRouteChildren = { AuthenticatedDashboardRoute }
const AuthenticatedRouteWithChildren = AuthenticatedRoute._addFileChildren(AuthenticatedRouteChildren)
const rootRouteChildren: RootRouteChildren = { IndexRoute, AuthenticatedRoute: AuthenticatedRouteWithChildren, LoginRoute, SignupRoute }
