...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "NAT Gestão" },
    ...
    links: [
      ...
      { rel: "apple-touch-icon", sizes: "180x180", href: "/icons/nat-180.png" },
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/icons/nat-192.png" },
