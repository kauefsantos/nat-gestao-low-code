...
type Product = { id: string; business_id: string; name: string; batch_yield: number; selling_price: number; loss_percent: number; production_cost_per_batch: number; minimum_margin_percent: number; target_margin_percent: number; active: boolean; created_at: string; updated_at: string };
...
type SaleItem = { id: string; business_id: string; sale_id: string; product_id: string; product_name_snapshot: string; quantity: number; unit_cost_snapshot: number; unit_price_snapshot: number; created_at: string };
...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      save_product: { Args: { p_business_id: string; p_id: string; p_name: string; p_batch_yield: number; p_selling_price: number; p_loss_percent: number; p_production_cost_per_batch: number; p_minimum_margin_percent: number; p_target_margin_percent: number; p_recipe: Json }; Returns: undefined };
